class Fixnum
  define_method(:numbers_to_words) do
    ...
    if self == 0
      ...
      teens_place_value = number_names[number_array[1].concat(number_array[0]).to_i]
    ...
    # if ones_place_value.defined?
    #   if tens_place_value.defined?
    #     if hundreds_place_value.defined?
    #       if thousands_place_value.defined?
    #
    #       end
    #     end
    #   end
